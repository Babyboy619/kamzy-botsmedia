...
import {
  Facebook, Instagram, Mail, Music2, Shield, MessageCircle, Twitter, Linkedin,
  AtSign, Inbox, Gift, Globe, Lock, BadgeCheck, Tag, Users, Award, Folder, Heart,
  ArrowRight, Check, Zap, Send, LifeBuoy, Menu,
} from "lucide-react";
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <ul className="mt-8 space-y-3">
            {["Bulk send to multiple clients", "Personalized branded message", "Instant email delivery", "Track redemption status"].map(b => (
