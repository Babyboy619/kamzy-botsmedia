        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-slate max-w-none space-y-8">
            ...
            <Section title="1. Who We Are">
              <p>KAMZYBOT'S MEDIA ("we", "us", or "our") operates a digital goods marketplace at <strong>kamzybotsmedia.store</strong>, where users can purchase social media account credentials and related digital products. We are committed to processing your personal data lawfully, fairly, and transparently.</p>
            </Section>
          ...
          <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <Link to="/terms" className="text-primary hover:underline text-sm font-medium">
