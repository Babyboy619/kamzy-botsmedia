        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-slate max-w-none space-y-8">
            ...
            <Section title="1. Acceptance of Terms">
              <p>By accessing and using KAMZYBOT'S MEDIA ("Platform", "we", "us", or "our") at kamzybotsmedia.store, you accept and agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use our Platform.</p>
            ...
            <Section title="2. Nature of Products and Services">
              <p>KAMZYBOT'S MEDIA is a digital goods marketplace that sells social media account credentials, aged accounts, and related digital products. All products are:</p>
              <ul>
            ...
            <Section title="13. Contact Us">
              ...
              <ul>
                ...
                <li><strong>Platform:</strong> <Link to="/contact" className="text-primary hover:underline">Contact Form</Link></li>
              </ul>
            </Section>
          ...
          <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <Link to="/" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-navy transition-colors">
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="space-y-3">
      <h2 className="text-lg font-bold text-navy border-l-4 border-primary pl-3">{title}</h2>
      <div className="text-[15px] leading-relaxed text-muted-foreground space-y-3 [&_strong]:text-navy [&_a]:text-primary [&_a:hover]:underline [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1.5">
        {children}
      </div>
    </div>
  );
